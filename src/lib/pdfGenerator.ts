...
export async function generateCustomerSubscriptionPDF(data: CustomerSubscriptionData): Promise<Uint8Array> {
  ...
  // Header
  drawText('CIRPMAN HOMES LTD', width / 2 - 100, 50, 18, helveticaBold, rgb(11, 61, 145));
  ...
  drawText('PERSONAL INFORMATION', 50, currentY, 14, helveticaBold, rgb(11, 61, 145));
  currentY += 30;
  ...
  drawText('PACKAGE & PAYMENT INFORMATION', 50, currentY, 14, helveticaBold, rgb(11, 61, 145));
  currentY += 30;
  ...
  if (data.installment_preview) {
    currentY += 20;
    drawText('INSTALLMENT PREVIEW', 50, currentY, 12, helveticaBold, rgb(212, 175, 55));
    currentY += 20;
    drawText(`First Deposit: ₦${data.installment_preview.firstDeposit.toLocaleString()}`, 50, currentY, 10);
    drawText(`Monthly Payment: ₦${data.installment_preview.monthlyPayment.toLocaleString()}`, 200, currentY, 10);
    drawText(`Total Amount: ₦${data.installment_preview.totalAmount.toLocaleString()}`, 350, currentY, 10);
    currentY += 30;
  }
  
  // Next of Kin Section
  drawText('NEXT OF KIN INFORMATION', 50, currentY, 14, helveticaBold, rgb(11, 61, 145));
  currentY += 30;
  ...
  drawText('DIGITAL SIGNATURE', 50, currentY, 14, helveticaBold, rgb(11, 61, 145));
  currentY += 30;
...
export async function generateConsultantSubscriptionPDF(data: ConsultantSubscriptionData): Promise<Uint8Array> {
  ...
  drawText('BANK ACCOUNT INFORMATION', 50, currentY, 14, helveticaBold, rgb(11, 61, 145));
  currentY += 30;
